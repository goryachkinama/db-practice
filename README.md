...
6. Объединение однотипных запросов. UNION, EXCEPT, INTERSECT
...
9. [SOME | ANY](https://learn.microsoft.com/ru-ru/sql/t-sql/language-elements/some-any-transact-sql?view=sql-server-ver16)
