---
Агрегатные функции и группировка: Лабораторная работа
---
...
1. Срез по продолжительности за последнюю неделю (по дням). Упорядочить по дате

   Поля:
   | День недели | Суммарная продолжительность |
   |----------|----------|
   
3. Срез по продолжительности каждого типа занятия за последнюю неделю (по дням). Упорядочить по дате

   Поля:
   | День недели | Суммарная продолжительность занятий типа 1 | Суммарная продолжительность занятий типа 2 | ... |
   |----------|----------|----------|----------|

5. Процент активных дней за последний месяц
6. Срез по продолжительности каждого предмета за последний год (по месяцам). Упорядочить по дате

   Поля:
   | Месяц | Суммарная продолжительность предмета 1 | Суммарная продолжительность предмета 2 | ... |
   |----------|----------|----------|----------|
