...
3. Срез по продолжительности каждого типа занятия за последнюю неделю (по дням). Упорядочить по дате
   ...
   Поля:
   | День недели | Суммарная продолжительность занятий типа 1 | Суммарная продолжительность занятий типа 1 | ... |
   |----------|----------|----------|----------|
...
6. Срез по продолжительности каждого предмета за последний год (по месяцам). Упорядочить по дате
   ...
   Поля:
   | Месяц | Суммарная продолжительность предмета 1 | Суммарная продолжительность предмета 1 | ... |
   |----------|----------|----------|----------|
