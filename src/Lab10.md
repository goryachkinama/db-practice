...
6. Удалить однозначный кластеризованный индекс в индексированном представлении
7. Создать обычное представление со столбцами «Кафедра», «Специальность» и «Сотрудник» данными о выпускающих кафедрах (факультет, шифр, название, фамилию заведующего). Выпускающей считается та кафедра, на которую есть ссылки в таблице «Специальность».
8. Изменить предыдущее представление на индексированное
