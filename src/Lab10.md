...
### Задания на индексированные представления по таблице студентов

1. Создать схему ? (дописать про схему)
2. Создать представление
3. Создать индекс
4. Модифицирование структуры индексированного представления
5. Редактирование информации, связанной с индексированными представлениями
6. Удалить чего-нибудь
