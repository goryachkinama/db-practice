...
* Библиотека
* Полиграфия
* [Управление доступом сотрудников](Lab15.md)
* Агентство недвижимости
* Аптечная сеть
* Автоматизация расчёта себестоимости единицы каждого вида продукции, выпускаемой некоторым предприятием
* Учёт автотранспорта, его автопробега и плановых ремонтов для организации
* Учёт библиотечного фонда библиотеки с распределённой территориальной структурой
